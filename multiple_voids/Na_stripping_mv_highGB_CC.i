#Case: Multiple voids at the electrode/SE separator interface.
#SE separator: Polycrystalline with high-conductivity GBs.
...
[Functions]
  ...
  [func_etaa0]
    ...
    inside_value = 1.0
    outside_value = 0.0
    table_name = 'multiple_pores_pos.txt'
  []
...
[Postprocessors]
  ...
  [mean_void_area]
    ...
    feature_counter = number_of_voids
    variable = etaa0
    execute_on = ${execute_on}
    outputs = all
  []
