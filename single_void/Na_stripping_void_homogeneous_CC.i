...
[Postprocessors]
  ...
  [vertical_pos_negative_y]
    ...
    target = 0.5
    v = etaa0
    start_point = '${fparse initial_metal_sei - 200} 0 0'
    end_point = '${fparse initial_metal_sei - 200} ${fparse -lateral_length/2/characteristic_length} 0'
    tol = 1e-8
    execute_on = '${execute_on}'
  [] 
